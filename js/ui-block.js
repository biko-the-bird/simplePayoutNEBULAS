    ...
    function insert(dic) {
        ...
        function footer(selector) {
            i18n.run($(selector)
                ...
                .html(
                    ...
                    "</nav>" +
                    '<div class="copyright text-center">Copyright &copy; 2018 simplePayout</div>'));
        }
        ...
        function header(selector) {
            var i, len,
                arr = [
                    "index.html",
                    "https://github.com/biko-the-bird/simplePayoutNEBULAS"
                ];
            ...
            i18n.run($(selector)
                ...
                .html(
                    ...
                    "    <a href=" + arr[0] + " data-i18n=header/simplePayout></a>" +
                    "    <a href=" + arr[1] + " data-i18n=header/about></a>" +
                    "</div>" +
                    "<hr>"));
        }
